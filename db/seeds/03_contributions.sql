...
VALUES (
  5, 1, 'His name was Cedric, a weary adventurer with tales etched into the lines of his weathered face. Seeking shelter from the tempest, Cedric stumbled upon the castles great oak doors, which creaked open with an eerie groan. Inside, he found himself in a grand hall adorned with tapestries depicting battles of old and chandeliers casting flickering light. But as Cedric ventured deeper into the castles labyrinthine corridors, he discovered secrets hidden within its walls.', '2024-03-30');

INSERT INTO contributions (
  user_id, story_id, content, submission_date)
  VALUES (
  2, 3, 'At the center of the room sat a wise old owl named Orion, who had been awaiting her arrival. Orion revealed that the tree was a portal to other realms, and Elara had been chosen to embark on a quest to restore balance to the enchanted lands beyond. Filled with excitement, Elara accepted the challenge and set off on her journey with Orion as her guide. Together, they faced many trials and obstacles, from treacherous forests to dark caves and raging rivers. But with courage and determination, they persevered, forming a bond stronger than any magic.', '2024-04-28');
