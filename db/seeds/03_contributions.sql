...
VALUES (
  5, 1, "His name was Cedric, a weary adventurer with tales etched into the lines of his weathered face. Seeking shelter from the tempest, Cedric stumbled upon the castle's great oak doors, which creaked open with an eerie groan. Inside, he found himself in a grand hall adorned with tapestries depicting battles of old and chandeliers casting flickering light. But as Cedric ventured deeper into the castle's labyrinthine corridors, he discovered secrets hidden within its walls.", is_approved, 2024-03-30 10:00:00, upvote_count);

INSERT INTO contributions (
  user_id, story_id, content, is_approved, submission_date, upvote_count)
  VALUES (
  2, 3, "At the center of the room sat a wise old owl named Orion, who had been awaiting her arrival. Orion revealed that the tree was a portal to other realms, and Elara had been chosen to embark on a quest to restore balance to the enchanted lands beyond. Filled with excitement, Elara accepted the challenge and set off on her journey with Orion as her guide. Together, they faced many trials and obstacles, from treacherous forests to dark caves and raging rivers. But with courage and determination, they persevered, forming a bond stronger than any magic.", is_approved, 2024-04-28 15:55:00, upvote_count);

INSERT INTO contributions (
  user_id, story_id, content, is_approved, submission_date, upvote_count)
  VALUES (
  3, 1, "Whispers of forgotten magic echoed through the chambers, and strange symbols adorned the doorways. Driven by curiosity, Cedric pressed on, his footsteps echoing in the silence. Each room revealed a new mystery, from ancient manuscripts to relics of power long thought lost. But with every discovery, he felt the castle's magic stirring, as if awakening from a slumber of centuries. As dawn broke and the storm subsided, Cedric emerged from Far Away Castle, his mind ablaze with wonder and excitement.", is_approved, 2024-03-21 11:11:11, upvote_count);

INSERT INTO contributions (
  user_id, story_id, content, is_approved, submission_date, upvote_count)
  VALUES (
  4, 1, "Though he had only scratched the surface of its secrets, he knew that his journey had only just begun. And so, with the castle fading into the horizon behind him, Cedric set forth into the world, eager to uncover the mysteries that awaited him beyond its enchanted walls. For in the heart of Far Away Castle, he had found not just shelter from the storm, but the promise of adventure beyond imagination.", is_approved,  2024-04-01 19:00:11, upvote_count);
